...
User management procedures for Gen2 VPC architecture have been reviewed and updated for compatibility with VPC-based deployments. Ensure IAM integration and security best practices are followed.
{: note}
